...
export default function Nav() {
  ...
  return (
    <div className="flex items-center gap-1 md:gap-2 justify-center fixed border-2 bottom-8 rounded-full bg-[#ffc014]/30 border-[#FFEFCF] left-[50%] translate-x-[-50%] z-100">
      {links.map(link => (
        <Link
